...
| 09-dec-2010 mig     removed parse- which was maybe for a previous
|                     version of parse (it fixes il)
...
: bl ( line# -- ) offset 64 blank ; | blankify line
...
: bh ( -- ) blocks 64k blank ; | blankify hood
