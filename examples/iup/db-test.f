...
: dumpButton callback userForm dump-db-form           gui-default ; 
: insertButton callback userForm dbinsert-stmt type cr  gui-default ; 
: updateButton callback userForm dbupdate-stmt type cr  gui-default ; 
: selectButton callback userForm dbselect-stmt type cr  gui-default ; 
...
: go  init-dlg  update-dlg show  gui-main-loop ;
to~ ~ go
