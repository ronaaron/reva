...
: redraw callback do-redraw  gui-default ; 

: resize callback 2 cb-param height !  1 cb-param width !  gui-default ; 

: jiggle callback  nof-particles 0 do i perturb loop  do-redraw  gui-default ; 
