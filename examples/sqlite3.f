...
db sql_prepared[ sql1 select c from a where b = :1 ]
db sql_prepared[ sql2 insert into blobs values(1, :1) ]
db sql_prepared[ sql3 select b from blobs where a=1 ]
...
: init
	...
	" test2.db" 2dup delete sql_open db  !
	sqlok?
