...
: start-cb 	( buttonptr -- )  0 cb-param play @ -1 xor play !	; 
: clear-cb 	( buttonptr -- )  0 cb-param clear-field  	; 
: hline-cb 	( buttonptr -- )  0 cb-param ['] hline setpat 	; 
: vline-cb 	( buttonptr -- )  0 cb-param ['] vline setpat 	; 
: square-cb 	( buttonptr -- )  0 cb-param ['] square setpat 	; 
: cross-cb 	( buttonptr -- )  0 cb-param ['] cross setpat 	; 
: pent-cb 	( buttonptr -- )  0 cb-param ['] pentomino setpat 	; 
: blocks-cb 	( buttonptr -- )  0 cb-param ['] blocks setpat 	; 
: sstep-cb 	( buttonptr -- )  1 play !	; 
: quit-cb 	( buttonptr -- )  0 to run	; 

\ window close handler
: close-cb     (  window   -- )  0 to run ; 
