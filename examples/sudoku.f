...
: wipe ( addr -- , erase buffer) ROW_SIZE cells zero ;
...
: gen ( a difficulty -- ) |  create a new sudoku at the 81 bytes pointed to by "a"
	over SUDOKU_SIZE cells zero	| create empty sudoku
...
{{ ." Sudoku 1:" cr sudoku1 .sudoku sudoku1 solve 
   if 
	." Solution: " cr sudoku1 .sudoku 
   else 
	." No solution." cr
   then
}}
